...
$sql=  "SELECT *,c.name uname,b.name bname FROM bookrec a,bookinfo b,user c where a.bookinfo_id=b.id and a.rec_id=c.id order by a.id desc  ";
...
$sqlajax="SELECT *,c.name uname,b.name bname FROM bookrec a,bookinfo b,user c where a.bookinfo_id=b.id and a.rec_id=c.id order by a.id desc limit $start,$pagenum";
